...
func RegisterUserHandler(userService *services.UserService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			...
			user, _ := userService.GetUserByEmail(newUser.Email)
...
func LoginUserHandler(userService *services.UserService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			...
			dbUser, err := userService.GetUserByEmail(loggedUser.Email)
			if err != nil {
