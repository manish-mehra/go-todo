...
func GetTodoHandler(todoService *services.TodoService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			...
			// get todo from db
			todo, err := todoService.GetTodo(todoID, userID)
			if err != nil {
...
func GetTodosHandler(todoService *services.TodoService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			...
			todos, err := todoService.GetAllTodos(userID)
			if err != nil {
				if errors.Is(err, utils.ErrNotFound) {
...
func PostTodoHandler(todoService *services.TodoService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			...
			err = todoService.PostTodo(newTodo, userID)
			if err != nil {
...
func DeleteTodoHandler(todoService *services.TodoService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			...
			// delete  todo from db
			err = todoService.DeleteTodo(todoID, userID)
			if err != nil {
				if errors.Is(err, utils.ErrNotFound) {
					http.Error(w, "Todo not found", http.StatusNotFound)
					return
...
func UpdateTodoHandler(todoService *services.TodoService) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, req *http.Request) {
			...
			// update the todo
			err = todoService.UpdateTodo(newTodo, todoID, userID)
			if err != nil {
				if errors.Is(err, utils.ErrNotFound) {
					http.Error(w, "Todo not found", http.StatusNotFound)
					return
